-- FORCE FIX for Ambiguous Function Error (PGRST203)
-- Run this in Supabase -> SQL Editor

BEGIN;

-- 1. Explicitly DROP conflicting signatures
-- Argument names must match exactly what Postgres thinks they are, or just use types.
...
-- 2. Recreate the SINGLE definitive function
CREATE OR REPLACE FUNCTION public.contract_upsert_milestone_draft(
    ...
    p_criteria text -- We accept TEXT to match the frontend call
)
