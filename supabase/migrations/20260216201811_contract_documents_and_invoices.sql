...
-- Both contract participants can view their documents
...
-- Allow insert for authenticated users (server action validates ownership)
CREATE POLICY "contract_documents_insert_authenticated"
ON public.contract_documents FOR INSERT TO authenticated
WITH CHECK (true);

-- Allow update for participants (acceptance)
...
-- ============================================================
-- 3. invoices — tracks generated invoices/receipts
-- ============================================================
...
-- Both contract participants can view invoices
...
-- Allow insert for authenticated users (server action validates)
