...
// TODO: import { generateCompanyInvoice } from "@/lib/pdf/generate-invoice"; // Will be added when PDF module is created
...
async function handleCheckoutCompleted(session: Stripe.Checkout.Session) {
  ...
  try {
    ...
    // Generate company invoice (non-blocking)
    try {
      ...
      const feePLN = session.metadata?.platform_fee
        ...
        : amountPLN * 0.10;
      // TODO: await generateCompanyInvoice(contractId, amountPLN, feePLN, "Stripe");
    } catch (invoiceErr) {
