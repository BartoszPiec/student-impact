...
export default function OfferCard({
    ...
    o: any,
    stats: { total: number, sent: number, accepted: number, hasApproved: boolean, hasDelivered?: boolean, acceptedAppId: string | null, acceptedProfile?: { first_name: string, last_name: string, id: string } | null, acceptedStudentId?: string | null, agreedStawka?: number | null }
}) {
